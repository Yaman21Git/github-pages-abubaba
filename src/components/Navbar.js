...
function Navbar() {
  ...
  <line x1="4" y1="18" x2="20" y2="18" />
          ...
          <div className="icons">
            <Link to="/search"><svg style={{cursor:"pointer"}} xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-search" width="40" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
